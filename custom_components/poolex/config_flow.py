...
class PoolexConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(
        ...
        """Return the options flow used by the integration cog."""
        return PoolexOptionsFlow(config_entry)


class PoolexOptionsFlow(config_entries.OptionsFlow):
    """Handle editable Poolex integration options."""
